                    ...
                    {{-- <div class="mt-6 border-gray-100 border-t pt-4 flex justify-between">
                        ...
                        <div class="flex">
                            <button class="mr-2 hover:opacity-75">
                                <i>
                                    <svg class="fill-current text-gray-300 w-6 h-6" height="512pt" viewBox="-96 0 512 512"
                                        width="512pt">
                                        <path
                            ...
                            <button class="hover:opacity-75">
                                <i>
                                    <svg class="fill-current text-gray-300 w-6 h-6" viewBox="0 0 477.867 477.867">
                                        <path
